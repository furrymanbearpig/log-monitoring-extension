...
public class FilePointerProcessor {
    private static final Logger LOGGER = LoggerFactory.getLogger(FilePointerProcessor.class);
    ...
    public void updateFilePointerFile() {
        ...
        try {
            ...
            LOGGER.error(String.format("Unfortunately an error occurred while saving filepointers to %s", file.getPath()), ex);
        }
    }
